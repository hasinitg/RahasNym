...
/**
 * This implements the IDMModule entry point which handles the requests received at the IDMInterface.
 */
public class IDMModule extends Thread{

    Socket clientSocket = null;

    public IDMModule(Socket socket) {
        super("IDMThread");
    ...
    public void run() {
        try (
            ...
            //read the content read by client
            ...
            if (fromClient != null) {
                ...
                String response = IDMConstants.ZKP_I + "," + commitmentBIG + "," + paramsString;
